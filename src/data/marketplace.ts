...
export const SEED_POSTS: MarketPost[] = [
  ...
  },
  {
    ...
    hoursAgo: 31,
    offers: [
      o("p4o1", "HDB", 13.8, 15.5, 36, 300_000_000, ["mk_c_nocol"], 26, 18),
    ],
  },
  {
    id: "p5",
    ...
    incomeBand: "mk_inc_3",
    collateral: true,
    verified: ["mk_v_income", "mk_v_collateral"],
    noteKey: "mk_seed_5",
    hoursAgo: 47,
    offers: [],
  },
